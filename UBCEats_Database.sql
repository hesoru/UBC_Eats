CREATE TABLE User_Has (
    ...
    User_Location_Longitude TEXT NOT NULL,
    User_Location_Latitude TEXT NOT NULL,
    FOREIGN KEY (User_Location_Longitude, User_Location_Latitude) REFERENCES Location(Longitude, Latitude)
);
...
CREATE TABLE Diet (
    Type (FK/PK from Restriction) TEXT
);
...
CREATE TABLE Stores (
    Dietary_Profile_Name (PK 1.1) TEXT,
    User_Username  (PK 1.2) TEXT,
    Allergen_Type  (PK 2) TEXT
);
